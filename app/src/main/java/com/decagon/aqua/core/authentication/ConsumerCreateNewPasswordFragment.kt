...
class ConsumerCreateNewPasswordFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.createNewTextView6.setOnClickListener {
            findNavController().navigate(R.id.action_consumerCreateNewPasswordFragment2_to_supplierSignUpFragment)
        }

        // navigate to password account successful
        binding.createNewButton2.setOnClickListener {
            findNavController().navigate(R.id.action_consumerCreateNewPasswordFragment2_to_passwordAccountSuccessfulFragment)
        }
    }
}
